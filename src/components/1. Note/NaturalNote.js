    ...
    <div className="window-wrapper">
      <div className="content-wrapper">
        ...
        <div className="text-wrap text-start">
          ...
          読み方は、「ツェーデーエーエフゲーアーハー」と10回ほど声に出して覚えてみましょう。<br></br><br></br>
          ドイツ語を覚えないと、ここから先の楽典を学ぶのは厳しいです。あまり親しみがないかもしれませんが、読み方も含めて確実に覚えてください。<br></br><br></br>
          <div class="my-sup">なお、本サイトでは特に断りがない限り音名をドイツ語で表記します。繰り返しになりますが、楽典を学ぶならドイツ語の音名を覚えるのはマストです。</div>
        </div>
        <h2>英語</h2>
        <div className="text-wrap text-start">
