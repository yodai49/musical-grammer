  ...
  return (
    <div className="window-wrapper">
      <div className="content-wrapper">
        ...
        長音階の場合、音階の7つめの音を「導音」と呼びました。そして、導音が主音を導けるのは、導音が主音の半音1つ分下に位置しているからでした。<br></br><br></br>

        しかし、自然的短音階には主音の半音下の音が含まれていません。例えば上のAから始まる自然的短音階における7番目の音はGとなっており、導音であるべきGisは含まれていません。<br></br><br></br>

        そこで、無理やり自然的短音階の第7音を半音上げて、主音の半音下である導音にしてしまうのが「和声的短音階」のアイディアです。<br></br>
        ...
        和声的短音階を作るときは、「まず自然的短音階を作り、第7音だけを半音上げる」と覚えておけばOKです。

        <QMinorScale3 id="Quiz3"/>

        <h2>旋律的短音階の構成音</h2>
        和声的短音階のアイディアにより、めでたく短音階に導音という存在が生まれました。<br></br><br></br>
        しかし、和声的短音階は非常に不思議な響きのする音階です。なぜなのでしょうか。<br></br>
        もう一度、和声的短音階の響きを注意深く聴いて、原因を考えてみてください。ヒントは、無理やり導入した導音の近くです。
        <Score id="MinorScale4" score="A,B,CDEF^GA"/>
        結論から言うと、導音とその一つ前の音の間が「半音3つ分」になっているため、不思議な響きが生まれてしまっています。<br></br>
        音階ではほとんど「半音1つ分」「半音2つ分（全音1つ分）」の音が隣り合っているのに、第7音を半音上げたせいでこの部分だけ例外的に間隔が広くなったのです。<br></br><br></br>
        
        この不思議な響きを解消してくれるのが、「旋律的短音階」です。<br></br>
        自然的短音階は音が上がっていくときと下がっていくときで形が違います。まずは上がっていくときを見ていきましょう。<br></br><br></br>

        音が上がっていくときの旋律的短音階では、導音とその前の音の間にある「半音3つ分」の間隔を解消するため、6番目の音を半音上げます。<br></br><br></br>
        ...
        また、下がっていくときは導音が必要ありません。そのため、自然的短音階と全く同じ音階となります。
        <Score id="MinorScale6" score="AGFEDCB,A,"/>

        以上の2つが、旋律的短音階です。<br></br>
        なお、上がっていく形を「上行形」、下がっていく形を「下行形」と呼びます。<br></br>
        <ul className="my-ul">
          <li>上行形……和声的短音階の6番目の音を半音上げる</li>
          <li>下行形……自然的短音階と全く同じ</li>
        </ul>
