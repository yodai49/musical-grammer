...
const QuizMajorScale1 = (props) => {
    return (
    <div className="quiz">
        <div>Fから始まる長音階に含まれる音をすべて答えてください</div>
        <QuizOptions id={props.id} text1="F, G, A, B, C, D, E, F" text2="F, G, A, B, Cis, Dis, E, F" text3="F, G, A, H, C, D, E, F" text4="正解は存在しない" />
...
export default QuizMajorScale1;