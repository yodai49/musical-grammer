  ...
  return (
    <div className="window-wrapper">
      <div className="content-wrapper">
        ...
        調とは、わかりやすく言えば「メロディーがどんな高さで演奏されるかを表す概念」です。<br></br>
        カラオケにおける「キー」だと思えば分かりやすいかもしれません。<br></br><br></br>

        それぞれの調には、主役となる音である「主音」が存在します。<br></br>
        曲のジャンルを問わず、メロディーは主音で始まったり、主音で終わったりすることが多いです。<br></br>
        実際、上の「キラキラ星」も、1つめの楽譜の主音は「ド」、2つめの楽譜の主音は「ソ」になっています。<br></br><br></br>

        調の概念を覚えると、一つの曲を違う高さで演奏できるようになったり、転調や曲の構成に対する理解が深まったりします。<br></br>
        ...
        <h2>調の種類と構成音</h2>
        調には、明るい響きのする「長調」と、暗い響きのする「短調」の2種類が存在します。<br></br><br></br>

        長調の構成音は、主音から始まる長音階です。<br></br>
        ...
        長音階の作り方が不安な場合は、<HashLink to="/MinorScale#title">短音階</HashLink>の章を復習してください。<br></br><br></br>

        私たちが普段触れる曲は、ほとんどが何らかの「調」を持っています。<br></br>
        そして、曲は基本的にそれぞれの調の構成音を使って演奏されます。<br></br><br></br>
        ...
        場合によっては構成音以外の音が使われることもありますが、基本的に曲は調の構成音がよく使われると覚えておきましょう。

        <h2>調の呼び名</h2>
        先ほどは、「Cを主音とする長調」「Gを主音とする短調」といったように調を呼びましたが、それぞれの調には短い名前が存在します。<br></br>
        日本語、ドイツ語、英語それぞれで呼び名が違うので、一つずつ見ていきましょう。<br></br><br></br>

        まずは日本語です。日本語では、それぞれの調を以下のように呼びます。
        <ul className="my-ul">
          <li>長調……（主音の日本語名）＋「長調」</li>
          <li>短調……（主音の日本語名）＋「短調」</li>
        </ul>
        例えば、Cを主音とする長調は「ハ長調」、Gを主音とする短調は「ト短調」となります。<br></br>
        調の名前を呼ぶときは、日本語を使うことが多いです。<br></br>
        他の言語と比べて重要度が高いので、確実に覚えておきましょう。<br></br><br></br>

        次に、ドイツ語です。ドイツ語では、それぞれの調を以下のように呼びます。
        <ul className="my-ul">
          <li>長調……（主音のドイツ語名）＋"dur"</li>
          <li>短調……（主音のドイツ語名）＋"moll"</li>
        </ul>
        読み方は、"dur"が「ドゥア−」、"moll"が「モール」です。<br></br>
